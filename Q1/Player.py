...
class MiniMaxPlayer(Player):
    ...
    def play(self, board):
        ...
        value, move = minimax(board, self.piece, 0, self.depth, True, -1000000, 1000000)
        return move
...
class MiniMaxProbPlayer(Player):
    ...
    def play(self, board):
        ...
        """
        # Todo: implement minimax algorithm with alpha beta pruning
        value, move = minimax_prob(board, self.piece, 0, self.depth, True, 0, 0, self.prob_stochastic)
        return move
